...
read_only_input_folder_name = fullfile(script_folder_name, 'yoshi-short-test-videos-read-only') ;
input_folder_name = fullfile(script_folder_name, 'yoshi-short-test-videos-expdir-false') ;
